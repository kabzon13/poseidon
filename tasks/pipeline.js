 ...
 *
 * (Note that you can take advantage of Grunt-style wildcard/glob/splat
 * expressions for matching multiple files, and ! in front of an expression to
 * ignore files.)
 *
...
// `tasks/README.md` for information on customizing and installing new tasks.
...
module.exports.cssFilesToInject = cssFilesToInject.map(
    function(cssPath) {
        // If we're ignoring the file, make sure the ! is at the beginning of
        // the path
        if (cssPath[0] === '!') {
